  ...
  return (
    <div>
      <div className="h-[30vh] bg-[url('https://images.unsplash.com/photo-1551503766-ac63dfa6401c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')] bg-no-repeat bg-center bg-cover flex justify-center items-center">
        <h1 className="text-center text-3xl font-bold">Terms of Use</h1>
      </div>
      <div className="w-100% md:w-4/5 md:mx-auto mx-4 space-y-8 my-8">
        <p>Version 1.0</p>

        <p>
          The 101 website located at https://llc101.github.io is a copyrighted
          work belonging to Seiax. Certain features of the Site may be subject
        ...
        <p>
          ...
          the Company should be sent to: Ghana, Cape Coast. After the Notice is
        ...
        <p>Address: Ghana, Cape Coast</p>
        <p>Email: one.zero.one.llc@gmail.com</p>
      </div>
    </div>
  );
}
